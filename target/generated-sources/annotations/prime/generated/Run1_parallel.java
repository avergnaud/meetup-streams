...
public final class Run1_parallel {
    ...
    public Collection<ThroughputResult> parallel_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            parallel_thrpt_jmhStub(control, res, l_run10_0, l_blackhole1_1);
    ...
    public void parallel_thrpt_jmhStub(InfraControl control, RawResults result, Run1_jmh l_run10_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<AverageTimeResult> parallel_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            parallel_avgt_jmhStub(control, res, l_run10_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void parallel_avgt_jmhStub(InfraControl control, RawResults result, Run1_jmh l_run10_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<SampleTimeResult> parallel_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            parallel_sample_jmhStub(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_run10_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_run10_0.parallel();
    ...
    public void parallel_sample_jmhStub(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Run1_jmh l_run10_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<SingleShotResult> parallel_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            int batchSize = control.iterationParams.getBatchSize();
            parallel_ss_jmhStub(control, batchSize, res, l_run10_0, l_blackhole1_1);
            control.preTearDown();
    ...
    public void parallel_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Run1_jmh l_run10_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
