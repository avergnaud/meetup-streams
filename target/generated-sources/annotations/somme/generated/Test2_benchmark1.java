...
public final class Test2_benchmark1 {
    ...
    public Collection<ThroughputResult> benchmark1_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_test20_0.benchmark1();
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            benchmark1_thrpt_jmhStub(control, res, l_test20_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "benchmark1", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void benchmark1_thrpt_jmhStub(InfraControl control, RawResults result, Test2_jmh l_test20_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<AverageTimeResult> benchmark1_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            Test2_jmh l_test20_0 = _jmh_tryInit_f_test20_0(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            benchmark1_avgt_jmhStub(control, res, l_test20_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "benchmark1", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void benchmark1_avgt_jmhStub(InfraControl control, RawResults result, Test2_jmh l_test20_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<SampleTimeResult> benchmark1_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            Test2_jmh l_test20_0 = _jmh_tryInit_f_test20_0(control, threadParams);
            ...
            benchmark1_sample_jmhStub(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_test20_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_test20_0.benchmark1();
    ...
    public void benchmark1_sample_jmhStub(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Test2_jmh l_test20_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<SingleShotResult> benchmark1_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            Test2_jmh l_test20_0 = _jmh_tryInit_f_test20_0(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            int batchSize = control.iterationParams.getBatchSize();
            benchmark1_ss_jmhStub(control, batchSize, res, l_test20_0, l_blackhole1_1);
            control.preTearDown();
    ...
    public void benchmark1_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Test2_jmh l_test20_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
